// components/rooms/RoomStatsCard.jsx
import React from 'react';

/**
 * ============================================
 * ROOM STATS CARD COMPONENT
 * ============================================
 * Displays individual stat cards in the rooms dashboard
 * 
 * @param {Object} props
...
const RoomStatsCard = ({ label, value, icon, bgColor = 'bg-blue-50', textColor = 'text-blue-600' }) => {
  return (
