...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#f5f5f5]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-indigo-100/10 rounded-full blur-2xl" />
          ...
          <div className="space-y-6">
            ...
            <div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 leading-[1.1]">
                Smart Management
                <span className="block bg-linear-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent bg-size-[200%_auto] gradient-animation">
                  Starts Here.
                </span>
              </h1>
              ...
              <div className="flex items-center gap-3 mt-4">
                <div className="h-1 w-16 bg-linear-to-r from-indigo-600 to-purple-600 rounded-full" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <button className="group relative px-8 py-4 bg-linear-to-r from-indigo-600 to-purple-600 text-white rounded-2xl font-semibold overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/25 hover:scale-105" onClick={()=>navigate("/signup")}>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100/50">
              ...
              <img 
                ...
                className="w-full h-90 md:h-105 object-cover"
                onError={(e) => {
              ...
              <div className="absolute -top-3 -right-3 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-3.5 border border-gray-100 hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 bg-linear-to-br from-green-400 to-emerald-500 rounded-xl flex items-center justify-center shadow-lg shadow-green-400/30">
              ...
              <div className="absolute -bottom-3 -left-3 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-3.5 border border-gray-100 hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 bg-linear-to-br from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-400/30">
              ...
              <div className="absolute -bottom-3 -right-3 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-3.5 border border-gray-100 hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 bg-linear-to-br from-orange-400 to-red-500 rounded-xl flex items-center justify-center shadow-lg shadow-orange-400/30">
